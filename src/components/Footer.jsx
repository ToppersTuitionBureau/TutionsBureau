  ...
  return (
    ...
    <footer className='bg-white text-black py-12 px-6 md:px-12'>
      ...
      <div>
        ...
        <p className='text-black-400 mb-2 text-sm'>Address: 123 Education Lane, City, Country</p> 
      </div>
</div>
      {/* Footer bottom */}
      <div>
        <p className='mt-8 pt-8 border-t border-gray-300 text-center text-black-400 text-sm'>&copy, 2025 Tuition Bureau. All Rights Reserved.</p>
      </div>
</footer>
    </>
  )
